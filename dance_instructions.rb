...
def skip_step(starting_foot)
  ...
  puts "Briefly raise the opposite foot, then the #{starting foot} twice more!"
end
def bob_the_reins
...
def lasso
  ...
  puts "Raise right forearm so that it points straight up, and whip it in small circles to the beat of the song, as if you were a cowboy "
end